...
- **Latest Tipsets** table containing: [Visit page](https://beryx.io/recent_activity)
...
- **Latest Transactions** table showing: [Visit page](https://beryx.io/recent_activity?tab=transactions)
...
- **Latest Contract Invokes** table containing: [Visit page](https://beryx.io/recent_activity?tab=contracts)
