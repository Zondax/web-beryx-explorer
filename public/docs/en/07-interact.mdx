...
![Contract verification form](./assets/image-15.webp)
 ...
 To call the selected method, you'll need to connect your wallet. This makes sure you have the funds and permissions to run write methods. If you're short on funds, no worries – you can visit our testnet faucet [here](https://beryx.io/faucet) to get some test FIL. The faucet for Filecoin Calibration is found in the sidebar. You can also connect your wallet from the top bar. There, you'll find your balance and transactions.
