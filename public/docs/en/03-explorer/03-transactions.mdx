...
Transaction example [here](https://beryx.zondax.ch/search/fil/mainnet/txs/bafy2bzaceab3xcn7qkcuj5oyifa6dn3ihke55bdmerphef4r6aorjdhk3uriq?tab=overview).
...
- **Gas used**: The value that represents the amount of gas used (units) in the transaction.
