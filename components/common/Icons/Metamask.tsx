...
/**
 * Interface for MetamaskIcon props
 */
...
/**
 * React component for the MetamaskIcon.
 *
 * @param props - Properties passed to component
 * @returns {JSX.Element}
 */
const MetamaskIcon = ({ size }: MetamaskIconProps): JSX.Element => {
  return (
    <svg data-testid="metamask-icon" fill="none" height={size - 2} viewBox="0 0 35 33" width={size} xmlns="http://www.w3.org/2000/svg">
