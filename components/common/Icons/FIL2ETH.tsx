 ...
 */
const FIL2ETH = ({ size, color = 'black' }: IconProps) => {
  return (
    <svg data-testid="fil2eth-icon" width={size} height={size} viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
      <g clipPath="url(#clip0_3108_15949)">
        <path
          d="M6 26V17.8281L2.4141 21.4141L1 20L7 14L13 20L1.5859 21.4141L8 17.8281V26H10.5V28H8C7.46976 27.9994 6.96142 27.7884 6.58649 27.4135C6.21155 27.0386 6.00064 26.5302 6 26Z"
          fill={color}
        />
        <path
