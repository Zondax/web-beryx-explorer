 ...
 * @type {Components}
 */
export const cardStyles = (palette: Palette): Components => {
  return {
    MuiCard: {
    ...
    MuiCardHeader: {
      ...
      styleOverrides: {
        root: {
          borderBottom: `1px solid ${palette.border?.level0}`, // Border at the bottom of the CardHeader
          padding: '0.75rem 1rem !important', // Padding for the CardHeader
        },
        title: {
